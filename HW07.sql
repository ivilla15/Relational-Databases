...
show tables;
#Q1
DROP TABLES IF EXISTS Authors2;
...
Update Authors2
Set au_fname="Buford"
Where au_lname="Kellsey" AND length(au_fname)<1;
#Q4
Alter Table Authors2 
ADD Email VARCHAR(30);
#Q5
Update Authors2
Set Email= Concat(lower(Left(au_fname, 1)), lower(au_lname), "@hotname.com");
#Q6
Update Authors2
Set phone= Concat(lower(Left(phone, 3)), Right(phone, Length(phone)-3))
Where city="San Francisco";
#Q7
DELETE FROM Authors2
WHERE au_id IN
(SELECT au_id
FROM Title_Authors ta INNER JOIN Titles t ON ta.title_id=t.title_id 
INNER JOIN Publishers p ON t.pub_id=p.pub_id Where pub_name='Tenterhooks Press');
#Q8
Alter Table Authors2
Drop Column Email;